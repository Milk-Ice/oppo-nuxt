...
import type { IDetailsProductType } from '@/types/details'
import { getDetailsInfoAPI } from '~~/service/details'
import { ref } from 'vue'
...
const { data } = await getDetailsInfoAPI(type as unknown as IDetailsProductType)
